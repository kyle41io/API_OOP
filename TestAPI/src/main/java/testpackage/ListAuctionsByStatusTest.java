...
import model.request.ListAuctionsByStatusRequest;
...
public class ListAuctionsByStatusTest {
    ...
    public ListAuctionsByStatusResponse getResult(ListAuctionsByStatusRequest request) throws IOException {
        System.out.println(request.getUrl_string());

        ListAuctionsByStatusResponse response = (ListAuctionsByStatusResponse) request.sendRequest();

        return response;
    }

    public void testAUnitTest(ListAuctionsByStatusRequest request, ListAuctionsByStatusResponse responseExpected) throws IOException {
        ListAuctionsByStatusResponse response = getResult(request);
    ...
    public void testAtIndexOfUnitTest(int index) throws IOException {
        ListAuctionsByStatusRequest request = new ListAuctionsByStatusRequest();
        ...
        ListAuctionsByStatusResponse response = new ListAuctionsByStatusResponse();
