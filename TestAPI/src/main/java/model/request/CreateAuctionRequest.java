...
public class CreateAuctionRequest extends Request {
    ...
    public String getUrl_string() {
        return URL.getBaseURL() + URLConstant.CREATE_AUCTION_URL + getParamsString();
    }
    ...
    public Response sendRequest() throws IOException {
        ...
        Gson g = new Gson();
        CreateAuctionResponse rp;
        try {
            rp = g.fromJson(content.toString(), CreateAuctionResponse.class);
