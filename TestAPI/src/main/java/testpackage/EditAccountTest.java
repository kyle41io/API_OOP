...
import model.request.EditAccountRequest;
...
public class EditAccountTest {
    public static final String TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..JBH5j2MqDZJ7SZA_b0YX6cph7WskmQoB7Vgh92KjEpI";
    ...
    public final String[] emails = {
            "hoangnt4@gmail.com",
            "hoangnt111@gmail.com",
            "hoangnt111@gmail.com",
            "hoangnt111@gmail.com",
            "hoangnt222@gmail.com",
            "hoangnt222@gmail.com",
            "",
            "hoangnt222@gmail.com",
            "hoangnt222@gmail.com",
            ...
            "hoangnt222",
            "hoangnt222@gmail",
            "\'hoang%20nt222@gmail.com\'",
            "hoang@nt222@gmail.com",
    ...
    public EditAccountResponse getResult(EditAccountRequest request) throws IOException {

        System.out.println(request.getUrl_string());

        EditAccountResponse response = (EditAccountResponse) request.sendRequest();

        return response;
    }

    public void testAUnitTest(EditAccountRequest request, EditAccountResponse responseExpected) throws IOException {
        EditAccountResponse response = getResult(request);
