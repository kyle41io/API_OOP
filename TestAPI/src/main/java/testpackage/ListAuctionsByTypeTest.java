...
import model.request.ListAuctionsByTypeRequest;
...
public class ListAuctionsByTypeTest {
    ...
    public ListAuctionsByTypeResponse getResult(ListAuctionsByTypeRequest request) throws IOException {
        System.out.println(request.getUrl_string());

        ListAuctionsByTypeResponse response = (ListAuctionsByTypeResponse) request.sendRequest();

        return response;
    }

    public void testAUnitTest(ListAuctionsByTypeRequest request, ListAuctionsByTypeResponse responseExpected) throws IOException {
        ListAuctionsByTypeResponse response = getResult(request);
    ...
    public void testAtIndexOfUnitTest(int index) throws IOException {
        ListAuctionsByTypeRequest request = new ListAuctionsByTypeRequest();
        ...
        ListAuctionsByTypeResponse response = new ListAuctionsByTypeResponse();
